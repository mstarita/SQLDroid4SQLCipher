...
public class SQLDroidConnection implements Connection {
    ...
    */
    ...
    public SQLDroidConnection(String url, Properties info) throws SQLException {
        ...
        synchronized(dbMap) {
            ...
            if (sqlitedb == null) {
                ...
                sqlitedb = new SQLiteDatabase(dbQname, password, timeout, retryInterval, flags);
     ...
     */
    public static SQLException chainException(net.sqlcipher.SQLException sqlException) {
