...
public class SQLiteDatabase {
  ...
  protected net.sqlcipher.database.SQLiteDatabase sqliteDatabase;
   ...
   */
  public SQLiteDatabase(String dbQname, String password, long timeout, long retryInterval, int flags) throws SQLException {
    super();
    ...
    while (sqliteDatabase == null) {
      try {
        sqliteDatabase = net.sqlcipher.database.SQLiteDatabase.openDatabase(dbQname, password, null, flags );
